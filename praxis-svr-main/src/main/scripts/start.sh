...
nohup java $JAVA_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS $JAVA_MEM_OPTS $JAVA_GC_OPTS -classpath $CONF_DIR:$LIB_JARS com.noriental.praxissvr.main.ServicePraxisAdmin > $STDOUT_FILE 2>&1 &
